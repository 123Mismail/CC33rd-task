...
function Political() {
  ...
  return ( <>
  <div className=" mx-auto justify-center text-center bg-[#aae7f1] hover:text-5xl p-4"><h1 className="text-4xl text- font-bold pt-10 text-[#08cbee] "> Political Books </h1></div>
    <div className=" grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 p-10 bg-[#8cd9e6] ">
