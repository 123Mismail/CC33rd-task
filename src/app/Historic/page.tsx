...
function Historic() {
  ...
  return ( <>
  <div className=" mx-auto justify-center text-center bg-[#ecc580] p-4"><h1 className="text-4xl font-bold pt-10 text-orange-500"> Historic Books </h1></div>
    <div className=" grid lg:grid-cols-4 md:grid-cols-3 bg-orange-300 grid-cols-1 p-10">
