...
function Religious() {
  ...
  return ( <>
  <div className=" mx-auto justify-center text-center p-4 bg-[#f1edd8]"><h1 className="text-4xl font-bold pt-10 text-[#605b49]"> Religious Books </h1></div>
    <div className=" grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 p-10 bg-[#e0d6b3]">
